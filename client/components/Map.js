...
//   const { pinnedLocations, rankedLocations } = props;
//   return (
//     <LoadScript
//       googleMapsApiKey="AIzaSyCGAwZZFUBYEamplYKpjoU647uO6oR9mOk"
//     >
//       <GoogleMap
...
//   pinnedLocations: state.pinned,
//   rankedLocations: state.ranked
// })

// export default React.memo(connect(mapStateToProps, null)(MyComponent));
